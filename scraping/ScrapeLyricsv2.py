...
artists=["Aesop-rock"]
artdf=pd.read_csv("/Users/christopherhedenberg/Downloads/projects/RapThesaurus/GeniusRapNamesv2.csv")
...
for artist in artists:
    ...
    for link in soup.find_all('a'):
        ...
        if "/artists/albums?for_artist_page" in string:
            a=rqst.get("https://genius.com"+string).text
            soup_a=bs(a)
